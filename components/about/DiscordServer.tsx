...
export default function DiscordServer() {
  ...
  if (isLoading || error) {
    return (
      <div
        className={`flex min-w-[250px] items-start justify-center rounded-xl bg-zinc-200 p-3 pr-3 dark:bg-zinc-800 md:pr-10`}
      >
  ...
  if (data)
    return (
      <div className="flex min-w-[250px] max-w-full items-center justify-start rounded-xl bg-zinc-200 p-3 dark:bg-zinc-800">
        <Link
